...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Plotting")) {
    ...
    ImGui::SameLine();
    ImGui::SliderInt("Sample count", &display_count, 1, 4000);
    float (*func)(void *, int) = (func_type == 0) ? Funcs::Sin : Funcs::Saw;
    ImGui::PlotLines("Lines", func, NULL, display_count, 0, NULL, -1.0f, 1.0f,
                     ImVec2(0, 80));
    ImGui::PlotHistogram("Histogram Yassa", func, NULL, display_count, 0, NULL,
...
static void ShowDemoWindowTables() {
  ...
  if (ImGui::TreeNode("Angled headers")) {
    ...
    if (ImGui::TreeNode("Style settings")) {
      ImGui::SameLine();
      HelpMarker("Giving access to some ImGuiStyle value in this demo for "
                 "convenience.");
      ImGui::SetNextItemWidth(ImGui::GetFontSize() * 8);
...
static void ShowDemoWindowInputs() {
  ...
  if (ImGui::CollapsingHeader("Inputs & Focus")) {
    ...
    if (ImGui::TreeNode("Shortcuts")) {
      ...
      // internally (gets priority when active) (Commmented because the
      ...
      if (ImGui::BeginPopup("PopupF")) {
        ...
        ImGui::Text("IsWindowFocused: %d, Shortcut: %s",
                    ImGui::IsWindowFocused(),
                    ImGui::Shortcut(key_chord, flags) ? "PRESSED" : "...");
        // (Commmented because the owner-aware version of Shortcut() is still in
        // imgui_internal.h)
  ...
  if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
    if (ImGui::BeginTabItem("Sizes")) {
      ...
      ImGui::SliderFloat2("DisplayWindowPadding",
                          ...
                          "%.0f");
      ImGui::SameLine();
      HelpMarker("Apply to regular windows: amount which we enforce to keep "
